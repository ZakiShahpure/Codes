...
cur.execute("create table if not exists employee(empno int PRIMARY KEY, name varchar(20), dept varchar(20),salary int)")
con.commit()
choice=None
while choice!=0:
    ...
    if choice == 1:
        ...
        query = "UPDATE google SET name='{}', dept='{}', salary={} WHERE empno={}".format(n, d, s,e)
        cur.execute(query)
        con.commit()
